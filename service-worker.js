const CACHE='starship-v4-shell-1';
const SHELL=['./','./index.html','./app.js','./ui-core.js','./explanations.js','./officers.js','./command-core.js','./manifest.webmanifest','./icons/starship-192.webp','./icons/starship-512.webp'];
